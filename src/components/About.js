      ...
      <div id="about">
        ...
        <div className="content-wrapper">
          ...
          <div className="content">
            ...
            <p>My newest passion is UX Design. I believe in creating things that have real meaning to the business and to the user. Informed design. That's the best invention yet.</p><br />
